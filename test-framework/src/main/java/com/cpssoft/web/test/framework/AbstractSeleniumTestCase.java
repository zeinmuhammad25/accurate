...
public abstract class AbstractSeleniumTestCase {
	private static final Logger log = LogManager.getLogger(AbstractSeleniumTestCase.class);
...
//									"drivers/chrome/windows/chromedriver.exe");
...
//							System.setProperty(ChromeDriverService.CHROME_DRIVER_EXE_PROPERTY,
//									"drivers/chrome/mac/chromedriver");
							 WebDriverManager.chromedriver().setup();
						     ChromeOptions co = new ChromeOptions();
						     co.addArguments("--remote-allow-origins=*");
						} else if (OSTool.isUnix()) {
//							System.setProperty(ChromeDriverService.CHROME_DRIVER_EXE_PROPERTY,
//									"drivers/chrome/unix/chromedriver");
							 WebDriverManager.chromedriver().setup();
						     ChromeOptions co = new ChromeOptions();
						     co.addArguments("--remote-allow-origins=*");
 //					         webDriver = new ChromeDriver(co);
	...
	// if (xmlTest != null && webDriver != null) {
	// webDriver.quit();
	// webDriver = null;
	// }
	// }
	...
	public static void overrideLocalWebDriver(WebDriver value) {
		localWebDriver.set(value);
	}
