...
public class PerusahaanPreferensiFitur extends AbstractAccurateTestCase {
	static Logger log = LogManager.getLogger(PerusahaanPreferensiFitur .class);
