...
public class PraOtomPreferensiAkunDefault extends AbstractAccurateTestCase {
	static Logger log = LogManager.getLogger(PraOtomPreferensiAkunDefault .class);

	private String TARGET_FILE = "PraOtomasi Preferensi - AkunDefault.txt";
