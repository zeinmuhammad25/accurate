...
public class PraOtomPreferensiPajak extends AbstractAccurateTestCase {
	static Logger log = LogManager
			.getLogger(PraOtomPreferensiPajak.class);

	private String TARGET_FILE = "PraOtomasi Preferensi - Pajak.txt";
