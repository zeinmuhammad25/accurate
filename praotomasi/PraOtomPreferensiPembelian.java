...
public class PraOtomPreferensiPembelian extends AbstractAccurateTestCase {
	static Logger log = LogManager
			.getLogger(PraOtomPreferensiPembelian.class);

	private String TARGET_FILE = "PraOtomasi Preferensi - Pembelian.txt";
	...
	@Test(dependsOnMethods = { "isiPreferensiPembelian" })
	public void editPreferensiPembelian() 
	{
		NavigationTool.klikMenuModul(getWebDriver(), AccurateModule.PREFERENSI);
		PreferensiParam param = new PreferensiParam();
	...
	@Test(dependsOnMethods = { "editPreferensiPembelian" })
