...
public class PerusahaanHakAkses extends AbstractAccurateTestCase {
	static Logger log = LogManager.getLogger(PerusahaanHakAkses .class);

	private String TARGET_FILE = "Perusahaan - HakAkses.txt";
