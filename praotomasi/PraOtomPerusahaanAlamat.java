...
public class PraOtomPerusahaanAlamat extends AbstractAccurateTestCase {
	static Logger log = LogManager.getLogger(PraOtomPerusahaanAlamat.class);

	private String TARGET_FILE = "PraOtomasi Perusahaan - Alamat.txt";
