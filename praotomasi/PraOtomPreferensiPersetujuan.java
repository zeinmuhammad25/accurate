...
public class PraOtomPreferensiPersetujuan extends AbstractAccurateTestCase {
	static Logger log = LogManager
			.getLogger(PraOtomPreferensiPersetujuan.class);

	private String TARGET_FILE = "PraOtomasi Preferensi - Persetujuan.txt";
