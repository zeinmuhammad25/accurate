...
public class PraOtomPreferensiLainLain extends AbstractAccurateTestCase {
	static Logger log = LogManager
			.getLogger(PraOtomPreferensiLainLain.class);

	private String TARGET_FILE = "PraOtomasi Preferensi - Lain Lain.txt";
